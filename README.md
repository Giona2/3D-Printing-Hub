...
1. Plug in the MicroSD card to the computer and run RPi Imager
  1. Click on choose device -> the model Pi you are using
  2. Click on choose OS -> Other raspberry Pi OS -> Raspberry Pi OS Lite
  3. Click on choose storage -> the name of the MicroSD card
  4. Click next
  5. Click edit properties -> Edit and change the settings as needed (SSH is optional, but is not used)
